...
function buildCharts(sample) {
  ...
  d3.json("samples.json").then((data) => {
    ...
    var sampleArr = sampleArray[0];
    var sampleWashArr = washArray[0];
    // 6. Create variables that hold the otu_ids, otu_labels, and sample_values.
    var otu_ids = sampleArr.otu_ids;
    console.log(otu_ids)
    var otu_labels = sampleArr.otu_labels;
    console.log(otu_labels)
    var sample_values = sampleArr.sample_values;
    console.log(sample_values)
    var wref = sampleWashArr.wfreq;
    console.log(wref)
